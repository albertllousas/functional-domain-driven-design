...
principle and the architectures based on it ... And I fell in love again, this time with hexagonal architecture.
...
What was next? divide and conquer! microservice architectures, it was time to me to time to create small, autonomous and decoupled services.
But, actually, I was going more to the path of creating distributed monoliths.
...
Now, I still feel that I know nothing, I still have to review concepts time to time, but in this project I will try to apply DDD,
FP, hexagonal, microservices and kotlin in a real scenario in order to see how powerful they are.
...
**Note**: This section and the following one are about DDD, feel free to jump directly to the [implementation section](#the-implementation) if you are not
interested, or you already master all the DDD concepts.

### The domain - Give me the loan!

In DDD terminology, the domain is the group of business problems we are trying to solve associated with one activity,
...
**DISCLAIMER:** This is just a domain to play with, I am not an expert, maybe some assumptions, terms or processes
are wrong; I apologise in advance.
...
In DDD world, this part is the strategic part, a crucial aspect of DDD, discovering the domain, breaking it down in
...
The original promise of microservices is to allow your teams to release frequently and independently of each other ... sounds familiar to you?
Yeah, bounded contexts and microservices are trying to achieve the same at different levels, that's why they are a perfect match!
...
We are lucky, we are the team in charge of Loan Evaluation, one of the core bounded contexts, but, what we know
about it?
...
to other domains, applications or third party services.
...
In summary, looking at the workflow as a pipeline, we are able to break down the work in small chunks of work that we
...
- Crashes: Are you going to recover or do anything with an exceptional crash? Let it crash and deal with them at
